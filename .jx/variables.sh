...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-semanticcheck/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-semanticcheck:0.0.8'
