...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-semanticcheck/HEAD/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-semanticcheck:0.0.6'
